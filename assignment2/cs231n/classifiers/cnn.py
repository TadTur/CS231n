...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        d, grads['W3'], grads['b3'] = affine_backward(soft_grad, affine2_cache)
        grads['W3'] += self.reg * W3
        d, grads['W2'], grads['b2'] = affine_relu_backward(d, affine1_cache)
        grads['W2'] += self.reg * W2
        d, grads['W1'], grads['b1'] = conv_relu_pool_backward(d, conv_cache)
